package org.giste.club.server.aspect;
...
public class TraceLogger {
	 ...
	 */
	@Before("execution(* org.giste.club.server..*.*(..))")
	 ...
	 */
	@AfterReturning(pointcut = "execution(!void org.giste.club.server..*.*(..))", returning = "returnValue")
	 ...
	 * @param joinPoint Information about the joint point.
	 */
	@After("execution(void org.giste.club.server..*.*(..))")
